...
// แทนที่ฟังก์ชันเดิมทั้งหมดด้วยนี้
function doFormSubmit(xhr) {
  console.log('▶ doFormSubmit called', xhr);
...
function initTelegramsettings() {
  callClick('telegram_test', function() {
    send('index.php/index/model/telegram/test', `chat_id=${$E('telegram_chat_id').value}&bot_token=${$E('telegram_bot_token').value}`, function(xhr) {
